 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint = 
		  ...
		  Person1 p1 = new Person1("Andrew Nelson");
		  toPrint += p1.toString("anelson35");
		  //Person2 replace P2 with your name
		  //and ggg000x with your gt num
		  Person2 p2 = new Person2("Lan Wang");
		  toPrint += p2.toString("lwang316");
		  //Person3 replace P3 with your name
		  //and ggg000x with your gt num
		  Person3 p3 = new Person3("Alex Trimm");
		  toPrint += p3.toString("atrimm7");
          //Person4 replace P4 with your name
          //and ggg000x with your gt num
          Person4 p4 = new Person4("David Li");
          toPrint += p4.toString("dli42");
		  //Person5 replace P5 with your name
          //and ggg000x with your gt num
          Person5 p5 = new Person5("Nikhil Dev Deshmudre");
          toPrint += p5.toString("ndeshmudre3");
