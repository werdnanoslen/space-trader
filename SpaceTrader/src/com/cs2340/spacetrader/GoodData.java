 ...
 * @version 1.0
 *  * This class helps to encapsulate the concept of having a certain quantity of a 
 * specific good. This class has just two data fields, Good and the amount of it held in 
 * an inventory. The Inventory class holds a list of GoodData objects, not Good objects.
 *
 */
